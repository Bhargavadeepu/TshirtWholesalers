...
public class SubCategoryProducts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //   Toast.makeText(getApplicationContext(), " Page Info  " + pageData, Toast.LENGTH_SHORT).show();
 ...
 /*       sort_layout.setOnClickListener(new View.OnClickListener() {
            ...
            *//*    Intent popup = new Intent(SubCategoryProducts.this, AlertpopupAcitivtiy.class);
                startActivity(popup);
    ...
    private void productApicall(String data) {
        ...
        if (CheckNetwork.isInternetAvailable(getApplicationContext())) {
            ...
            Storefront.QueryRootQuery query = Storefront.query(rootQuery -> rootQuery
                    .shop(shop -> shop
                            .products(arg -> arg.first(20).query(data).after(productPageCursor), connection -> connection
    ...
    private void sortServiceCall(String data) {
        ...
        if (CheckNetwork.isInternetAvailable(getApplicationContext())) {
            ...
            graphClient = GraphClient.builder(getApplicationContext())
                    ...
                    .httpCache(new File(getApplication().getCacheDir(), "/https"), 10 * 1024 * 1024)
...
/*
    ...
    private void pagination(String data) {
        ...
        if (CheckNetwork.isInternetAvailable(getApplicationContext())) {
            ...
            //pageData   "Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzQ0MDk2OTc0MQ=="
